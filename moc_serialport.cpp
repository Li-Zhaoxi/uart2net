...
QT_MOC_LITERAL(1, 11, 22), // "signals_serial_receive"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 16) // "begin_to_receive"

    },
    "SerialPort\0signals_serial_receive\0\0"
    "begin_to_receive"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signals_serial_receive((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->begin_to_receive(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPort::signals_serial_receive)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPort::signals_serial_receive(QByteArray _t1)
{
